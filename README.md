...
All the codes are distributed under MIT License on [GitHub](https://github.com/gstinoco/mGFD-Advection-Diffusion) and are free to use, modify, and distribute giving the proper copyright notice.
