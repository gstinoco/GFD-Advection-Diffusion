...
## Problem Parameters
v = 0.001                                                                                   # Diffusion coefficient.
a = 0.4                                                                                     # Transport velocity on the x direction.
b = 0.4                                                                                     # Transport velocity on the y direction.
t = 2000                                                                                    # Number of time-steps.

## Function for the problem.
f = lambda x, y, t, v, a, b:  np.heaviside(0.5 - (x - a*t), 1) * np.heaviside(0.5 - (y - b*t), 1)
